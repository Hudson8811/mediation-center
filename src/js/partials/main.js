window.addEventListener('load', () => {
  ...
  selects.forEach(it => {
   ...
   /* window.initialisedChoices={};
    selects.forEach(function(current_node, index){
      // create a new property on it, which will store Choices

      window.initialisedChoices[index]=new Choices(current_node, {
        searchEnabled: false,
        shouldSort: false,
        shouldSortItems: false,
        loadingText: 'Загрузка...',
      ...
      current_node.setAttribute('data-initialised-choices-instance-id',index);
     // window.initialisedChoices
    })*/
